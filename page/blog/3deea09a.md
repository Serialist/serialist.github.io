...
系统本质就是一个动态函数：输入一个量，然后输出状态的变化:
$$
u = \begin{pmatrix} 电机输出力 \end{pmatrix} \\
x = \begin{pmatrix} 倾斜角度 \\ 倾斜角速度 \\ 位移 \\ 速度 \end{pmatrix} \\
\dot{x} = f(x,u)
$$
...
> 可恶我似乎忘了做 mermaid 渲染，上面的开环闭环那里本来是一个流程图的，以后再改吧我懒了
