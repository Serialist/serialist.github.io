...
Mermaid 是一种能表示图标的语言，你可以通过它画一些简单的流程图。

Markdown 常常和 Tex、Mermaid 等其他语言搭配，比如使用 Latex 语法来写公式，非常方便，且易迁移。
...
菜鸟教程的其他内容也可以看看，较为简单，相当适合新手（和名字搭配最好的一集）
...
> [Typora 资源](https://www.serialist.top/download/typora-setup-x64.exe)
>
> [Typora 解锁软件](https://www.serialist.top/download/Typroa_Activation_Script.7z)
